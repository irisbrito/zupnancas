...
public class CadastroDeContaPagaException extends RuntimeException {
    private int Status = 400;
    private String campo = "Status";
    private String razaoDoErro = "Bad request";
    private String tipoDoErro = "Conta paga não pode ser cadastrada";

    public CadastroDeContaPagaException(String message) {
        super(message);
    }
